...
describe Simulator do 
  ...
  describe "when given valid input" do
    ...
    it "places the robot" do
      ...
      }.to output("I am at position 1,1 facing NORTH\n").to_stdout
    end
    ...
    it "moves the robot" do
      ...
      expect { 
        @simulator.process("REPORT") 
      }.to output("I am at position 1,2 facing NORTH\n").to_stdout
    end
    ...
    it "turns the robot left" do
      ...
      expect { 
        @simulator.process("REPORT") 
      }.to output("I am at position 1,1 facing WEST\n").to_stdout
    end
    ...
    it "turns the robot right" do
      ...
      expect { 
        @simulator.process("REPORT")
      }.to output("I am at position 1,1 facing EAST\n").to_stdout
    end
  ...
  describe "when given invalid input" do
    ...
    it "doesn't accept invalid commands" do
      expect { 
        @simulator.process("INVALID") 
      }.to output(/Invalid command/).to_stdout
    end

    it "doesn't place the robot when given invalid coordinates" do
      expect { 
        @simulator.process("PLACE 9,7,NORTH") 
      }.to output(/Invalid PLACE command/).to_stdout
    end

    it "doesn't place the robot when given an invalid direction" do
      expect { 
        @simulator.process("PLACE 1,1,INVALID")
      }.to output(/Invalid PLACE command/).to_stdout
    end
